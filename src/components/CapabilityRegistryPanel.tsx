...
export default function CapabilityRegistryPanel() {
  ...
  const handleInjectSignatureDrift = () => {
    ...
    setVerificationResult('NONE');
    setVerificationError(null);
    addLog('CRITICAL: Block #2 data compliance hash drift injected in memory.', 'WARN', 'GOVERNOR');
    addLedgerEvent('JOURNAL_SIGNATURE_DRIFT_INJECTED');
  };
      ...
      <div className="md:col-span-12 bg-[#0A0A0A] border border-[#222] p-5 rounded-lg flex flex-col space-y-4">
        <div className="flex justify-between items-center border-b border-[#222] pb-3 shrink-0">
          ...
          <div className="flex gap-2">
            ...
            {/* Inject Signature Drift */}
            <button
              onClick={handleInjectSignatureDrift}
              ...
              title="De-align block hash without signing to test verification mechanics"
            >
